  ...
  return (
    <>
      <PageHeader
        eyebrow="Our work"
        title="Gallery"
        subtitle="Installations, chimney work and stoves in their natural habitat — Kenyan homes."
      />
      ...
      <CtaBanner
        title="Planning a stove for your home?"
        copy="Send photos or a quick description — we'll help you pick a model and book a site visit."
      >
